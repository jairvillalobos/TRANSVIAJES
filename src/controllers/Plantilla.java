...
public class Plantilla {    
    ...
    public Plantilla(String nombreGerente,
            String fecha,
            String rutaImagen,
            List<Persona> personas,
            String cedula)
    ...
    Plantilla(String jair, String villalobos, String string, String homejairDescargaslogopng) {
    ...
    public void crearPlantilla(String nombreArchivo){
        try {
            ...
            documento.add(new Paragraph("Gerente de Operaciones: " + nombreGerente));
